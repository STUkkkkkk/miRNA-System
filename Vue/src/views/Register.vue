<template>
    <div style="width: 100%;height: 100vh ;background-color: white; overflow: hidden">
        <div style= "width:400px ;margin: 130px auto; margin-top: 50px">
            ...
            <div style="color: black; font-family: 楷体; font-size: 30px; text-align: center; padding-bottom: 15px">欢迎注册</div>
            <el-form :model="form" ref="form" size="normal" :rules="rules" style="width: 300px;font-family: 楷体;  margin-left: 50px">
                <el-form-item prop="username">
                    <el-input :prefix-icon="User" clearable v-model="form.username" placeholder="请输入用户名"></el-input>
                </el-form-item>
                ...
                <el-form-item>
                    ...
                    <el-button style="margin-left: 120px;font-family: 楷体;width: 30%; background-color: azure" @click="register">注册账号</el-button>
                </el-form-item>
            </el-form>
        </div>
    </div>
                   ...
                   if(valid){
                       request.post("/user",this.form).then(res=>{
                           if(res.code === "0"){
                               ...
                               this.$router.push("/login");//注册成功，跳转页面
                           }
